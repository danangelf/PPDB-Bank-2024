...
@section('content')
<h3 class="text-gray-700 text-3xl font-medium">Siswa</h3>
<div class="container bg-white p-10 my-10" x-data="dataCrud()">
    ...
    <x-modal :value="1">
        ...
        <div class="border-b-2 border-black mb-4">
            <h2 class="text-3xl font-medium" :id="$id('modal-title')">Form Data Sekolah</h2>
        </div>
        <!-- Content -->
    ...
    <div class="w-full grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
        ...
        <div class="w-full px-3 my-3">
            <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="sekolah">
                Sekolah
            </label>
        ...
        <x-slot:tbody>
            <template x-for="(row, index) in datatable.data" :key="index">
                <tr x-show="!datatable.loading" class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3" x-text="row.nik"></td>
