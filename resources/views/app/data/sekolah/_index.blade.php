...
@section('content')
<h3 class="text-gray-700 text-3xl font-medium">Sekolah</h3>
    ...
    <x-app.datatable.datatable>
        <x-slot:thead>
            <tr>
                ...
                <th scope="col" class="px-4 py-3">NPSN</th>
        ...
        <x-slot:tbody>
            <template x-for="(row, index) in datatable.data" :key="index">
                <tr x-show="!datatable.loading" class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3" x-text="row.npsn"></td>
...
@section('_inJs')
@include('app.data.sekolah._inJs')
@endsection
<!-- /Your Custom Javascript -->
